...
<section class="dashboard">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 border shadow p-4 mb-5 bg-body rounded">
                <div class="row">
                    <div class="row mb-3">
                        <div class="col-lg-1">
        ...
        success : function(res){
            ...
            if(res.success){
                ...
                for(var x = 0; x < vData.length ; x++ ){
                    ...
                    stHtml += "<td>"+vData[x].year_manufactured+"</td>";
                    stHtml += "<td>"+vData[x].engine_capacity+"</td>";
                    ...
                    if(vData[x].type == 'Sell'){
                        stHtml += "<td class='table-primary'>"+vData[x].type+"</td>";
                    }else{
                        stHtml += "<td class='table-danger'>"+vData[x].type+"</td>";
                    }
